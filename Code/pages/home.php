...
function url_for(string $name, array $params = []): string {
    $map = [
        'home.home'                      => '/pages/home.php',   // ✅ Home points to home.php
...
if ($is_logged_in) {
    ...
    try {
        ...
        error_log('Home fetch rows error: ' . $e->getMessage());
    }
    ...
    try {
        ...
        error_log('Home fetch counts error: ' . $e->getMessage());
    }
...
include __DIR__ . '/../includes/base.php';   // ✅ go up one level to includes/